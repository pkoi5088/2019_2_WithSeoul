...
<head>
<meta charset="utf-8">
<title>장소추천하기-내가쓴글</title>
<link rel="stylesheet" type="text/css" href="../../Css/my_view.css">
</head>
<body>
	<%
	...
	<%
		...
		String sql = "select * from post_tbl where name = '" + Nick + "'";
		int startnum = 0;
	...
	<script>
			...
			document.location.href="My_view.jsp?page=1";
		</script>
	<%
	...
	<script>
			alert('페이지의 범위를 벗어났습니다.');
			document.location.href="My_view.jsp?page=<%=endnum / 10 + 1%>";
	</script>
	<%
		}
		if (flag) {
			sql = "select * from post_tbl where name = '" + Nick + "' limit " + (num - 1) * 10 + ",10";
	...
	<div id="notice_write">
		<table id="notice_tbl">
			<tr>
				...
				<th id="tbl_th1" style="border-right: none;">관리</th>
			</tr>
			<%
				while (rs.next()) {
			...
			<tr>
				...
				<td id="tbl_td1" style="border-right: none;"><a href="../../Post/Delete.jsp?num=<%=rnum%>">삭제</a></td>
			</tr>
			<%
				}
				}
